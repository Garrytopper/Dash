...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'dash_core.doctrinelistener_applications' => 'getDashCore_DoctrinelistenerApplicationsService',
            'dash_dvente.gestionvente' => 'getDashDvente_GestionventeService',
            'dash_portefeuille.clientmodificator' => 'getDashPortefeuille_ClientmodificatorService',
            'dash_taches.task_creator' => 'getDashTaches_TaskCreatorService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('vUp76Wa-0T', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1BoLE-Bn8D', 0, '-WZUHb5CSLPRoyz2ZBz5je', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /**
     * Gets the 'dash_core.doctrinelistener_applications' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dash\CoreBundle\DoctrineListener\DoctrineListenerApplications A Dash\CoreBundle\DoctrineListener\DoctrineListenerApplications instance
     */
    protected function getDashCore_DoctrinelistenerApplicationsService()
    {
        return $this->services['dash_core.doctrinelistener_applications'] = new \Dash\CoreBundle\DoctrineListener\DoctrineListenerApplications($this->get('dash_portefeuille.clientmodificator'), $this->get('dash_taches.task_creator'), $this->get('dash_dvente.gestionvente'));
    }

    /**
     * Gets the 'dash_dvente.gestionvente' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dash\DventeBundle\GestionVente\GestionVente A Dash\DventeBundle\GestionVente\GestionVente instance
     */
    protected function getDashDvente_GestionventeService()
    {
        return $this->services['dash_dvente.gestionvente'] = new \Dash\DventeBundle\GestionVente\GestionVente($this->get('router'));
    }

    /**
     * Gets the 'dash_portefeuille.clientmodificator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dash\PortefeuilleBundle\ClientModificator\ClientModificator A Dash\PortefeuilleBundle\ClientModificator\ClientModificator instance
     */
    protected function getDashPortefeuille_ClientmodificatorService()
    {
        return $this->services['dash_portefeuille.clientmodificator'] = new \Dash\PortefeuilleBundle\ClientModificator\ClientModificator();
    }

    /**
     * Gets the 'dash_taches.task_creator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dash\TachesBundle\TaskCreator\TaskCreator A Dash\TachesBundle\TaskCreator\TaskCreator instance
     */
    protected function getDashTaches_TaskCreatorService()
    {
        return $this->services['dash_taches.task_creator'] = new \Dash\TachesBundle\TaskCreator\TaskCreator();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'preUpdate'), $this->get('dash_core.doctrinelistener_applications'));
        $c->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'dash', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Dash/CoreBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Dash/PortefeuilleBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Dash/TachesBundle/Entity'), 3 => ($this->targetDirs[3].'/src/Dash/DventeBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Dash\\CoreBundle\\Entity');
        $c->addDriver($b, 'Dash\\PortefeuilleBundle\\Entity');
        $c->addDriver($b, 'Dash\\TachesBundle\\Entity');
        $c->addDriver($b, 'Dash\\DventeBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('DashCoreBundle' => 'Dash\\CoreBundle\\Entity', 'DashPortefeuilleBundle' => 'Dash\\PortefeuilleBundle\\Entity', 'DashTachesBundle' => 'Dash\\TachesBundle\\Entity', 'DashDventeBundle' => 'Dash\\DventeBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2d3a50313559bfdacdd5f83b08e71c4737ddab09de45d4ff7fbe496074ffc73d');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('VgKXj8nck3', NULL, '-WZUHb5CSLPRoyz2ZBz5je', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Dash/CoreBundle/Resources/views'), 'DashCore');
        $instance->addPath(($this->targetDirs[3].'/src/Dash/PortefeuilleBundle/Resources/views'), 'DashPortefeuille');
        $instance->addPath(($this->targetDirs[3].'/src/Dash/TachesBundle/Resources/views'), 'DashTaches');
        $instance->addPath(($this->targetDirs[3].'/src/Dash/DventeBundle/Resources/views'), 'DashDvente');
        $instance->addPath(($this->targetDirs[3].'/src/Dash/SecurityBundle/Resources/views'), 'DashSecurity');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f67457fda6a3d515c0cc4590f92104d69306083c');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0v1Ty8UhKB', 0, '-WZUHb5CSLPRoyz2ZBz5je', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('yan', 'test', array(0 => 'ROLE_ADMIN')));
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'DashCoreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Dash/CoreBundle'),
                    'namespace' => 'Dash\\CoreBundle',
                ),
                'DashPortefeuilleBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Dash/PortefeuilleBundle'),
                    'namespace' => 'Dash\\PortefeuilleBundle',
                ),
                'DashTachesBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Dash/TachesBundle'),
                    'namespace' => 'Dash\\TachesBundle',
                ),
                'DashDventeBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Dash/DventeBundle'),
                    'namespace' => 'Dash\\DventeBundle',
                ),
                'DashSecurityBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Dash/SecurityBundle'),
                    'namespace' => 'Dash\\SecurityBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DashCoreBundle' => 'Dash\\CoreBundle\\DashCoreBundle',
                'DashPortefeuilleBundle' => 'Dash\\PortefeuilleBundle\\DashPortefeuilleBundle',
                'DashTachesBundle' => 'Dash\\TachesBundle\\DashTachesBundle',
                'DashDventeBundle' => 'Dash\\DventeBundle\\DashDventeBundle',
                'DashSecurityBundle' => 'Dash\\SecurityBundle\\DashSecurityBundle',
            ...
            'secret' => 'f67457fda6a3d515c0cc4590f92104d69306083c',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'f67457fda6a3d515c0cc4590f92104d69306083c',
